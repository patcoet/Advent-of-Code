...
for instruction in instructions:
  ...
  if result_is_true:
    ...
    highest_recorded_value = max(highest_recorded_value, registers[register_to_modify])
...
print("Highest final value:", max(values))
print("Highest ever value:", highest_recorded_value)