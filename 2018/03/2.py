...
for claim in claims:
  squares_covered_by_claim = squares_covered_by(claim)
  num_squares_covered_by_claim = len(squares_covered_by_claim)
  counter = 0
  for square in squares_covered_by_claim:
    if squares_covered[square] == 1:
      counter = counter + 1
  if counter == num_squares_covered_by_claim:
